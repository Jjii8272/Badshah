...
TOKEN = '7422017555:AAFCrYPifzpQxy_knB0kvJrlUddHwBZ6uYs'
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="❤‍🩹 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤‍🩹", url="https://t.me/+jHP_zYeafQNlZjU9")
    button1 = types.InlineKeyboardButton(text="👤 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 👤",
        url="https://t.me/Bgmi_owner_420")
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*𝗔𝘁𝘁𝗮𝗰𝗸 𝗦𝘁𝗮𝗿𝘁𝗲𝗱🔥\n\n𝗧𝗮𝗿𝗴𝗲𝘁: {target_ip}\n𝗣𝗼𝗿𝘁: {target_port}\n𝗧𝗶𝗺𝗲: {duration} 𝐒𝐞𝐜.\n᚛ @Bgmi_owner_420 ᚜*", reply_markup=create_inline_keyboard(),parse_mode='Markdown')
